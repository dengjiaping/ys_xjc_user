    ...
    protected void callBackForServerSuccess(HemaNetTask netTask,
        ...
        switch (information) {
            case NOTICE_UNREAD:
                ...
                count_order = Integer.parseInt(isNull(sResult.getObjects().get(0).getCount()) ? "0" : sResult.getObjects().get(0).getCount());
                if (count_order == 0)
            ...
            case NOTICE_LIST:
                ...
                HemaArrayParse<NoticeListInfor> cResult = (HemaArrayParse<NoticeListInfor>) baseResult;
