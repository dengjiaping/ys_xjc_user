...
public class NewAlbumAdapter extends CommonAdapter<String> {
	...
	public NewAlbumAdapter(Context context, List<String> mDatas, int itemLayoutId,
	...
	public void convert(final ViewHolder helper, final String item) {
		...
		helper.setImageResource(R.id.id_item_select,
				R.drawable.album_picture_unselected);
		// 设置图片
		...
		mImageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mSelectedImage.contains(item)) {
					...
					mSelect.setImageResource(R.drawable.album_picture_unselected);
					mImageView.setColorFilter(null);
				} else
				// 未选择该图片
				{
					...
					mSelect.setImageResource(R.drawable.album_pictures_selected);
