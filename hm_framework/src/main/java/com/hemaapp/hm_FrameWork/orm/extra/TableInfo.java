...
public class TableInfo {
    ...
    private <T> void setInit() {
        ...
        XtomLogger.v(SqliteUtility.TAG, "类" + clazz.getSimpleName() + "的主键是" + primaryKey.getColumn());
        for (TableColumn column : columns) {
            XtomLogger.v(SqliteUtility.TAG, "[column = " + column.getColumn() + ", datatype = " + column.getDataType() + "]");
        }
    }
